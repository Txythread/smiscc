...
impl Architecture {
    pub fn get_object(&mut self, object: Uuid) -> (Register, Vec<AssemblyInstruction>) {
        ...
        let mut result_reg = self.provide_empty_register();
    ...
    pub fn provide_empty_register(&mut self) -> (Register, Vec<AssemblyInstruction>) {
